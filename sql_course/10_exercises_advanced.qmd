...
:::{.notes}
SELECT w.teamnr, COUNT(*) as verloren_wedst, SUM(w.gewonnen) AS aantal_gew_sets,t.divisie
FROM wedstrijden w JOIN teams t ON t.teamnr = w.teamnr
WHERE w.gewonnen < w.verloren AND w.verloren -w.gewonnen < 3
GROUP BY w.teamnr,t.divisie
ORDER BY verloren_wedst, aantal_gew_sets DESC, t.divisie
:::
