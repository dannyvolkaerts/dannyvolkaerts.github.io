...
Geef de nummers van de boetes die qua boetebedraag gelijk zijn aan een boetebedrag behorende bij speler 44. Het resultaat dient niet de boetes van speler 44 te bevatten.
...
FROM spelers, boetes\
WHERE spleers.spelersnr = boetes.spelersnr\
AND geb_datum > '1920-06-30'\

EXPLICIET:\
SELECT spelers.spelersnr, naam, bedrag\
FROM selers INNER JOIN boetes on spelers.spelersnr = boetes.spelersnr\
...
:::{.notes}
SELECT s.spelersnr, naam, bedraag, teamnr\
